...
df_registro_salarial.to_csv(r"registro_salarial.csv")
df_letra.to_csv(r"letra.csv")
df_sector.to_csv(r"sector.csv")
df_localidad.to_csv(r"localidad.csv")
df_municipio.to_csv(r"municipio.csv")
df_departamento.to_csv(r"departamento.csv")
df_provincia.to_csv(r"provincia.csv")
df_categoria.to_csv(r"categoria.csv")
df_certificadora.to_csv(r"certificadora.csv")
df_operador.to_csv(r"operador.csv")
df_productos.to_csv(r"producto.csv")
producto_por_operador.to_csv(r"producto_por_operador.csv")
